...
## To delete the resources and clean up the AKS cluster

1. Save this script in a file, for example, delete-aks-cluster.sh, in your project directory.

2. Make the script executable:

```
chmod +x delete-aks-cluster.sh
```
...
```
vagrant@cloud-native-box:~/azure-aks-cluster-cli-deployment/scripts$ ./delete-aks-cluster.sh
Deleting all resources in the AKS cluster...
pod "order-service-76d7f5b8f5-v8snj" deleted
pod "product-service-7566c548bd-wdr27" deleted
pod "rabbitmq-6ddd848578-dhp5r" deleted
pod "store-front-7cc6c7bb67-gmqzq" deleted
service "kubernetes" deleted
service "order-service" deleted
service "product-service" deleted
service "rabbitmq" deleted
service "store-front" deleted
deployment.apps "order-service" deleted
deployment.apps "product-service" deleted
deployment.apps "rabbitmq" deleted
deployment.apps "store-front" deleted
...
https://docs.microsoft.com/en-US/cli/azure/aks#az_aks_delete
Read more about the command in reference docs
...
Read more about the command in reference docs
Removing cluster from kubectl config...
warning: this removed your active context, use "kubectl config use-context" to select a different one
deleted context akhDemoAKSCluster from /home/vagrant/.kube/config
deleted cluster akhDemoAKSCluster from /home/vagrant/.kube/config
Deletion process initiated. It may take several minutes to complete.
vagrant@cloud-native-box:~/azure-aks-cluster-cli-deployment/scripts$ 
```
